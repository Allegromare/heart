...
def add_reading(request):
    ...
    if request.method == 'POST':
        ...
        try:
            reading_date = datetime.datetime.fromisoformat(request.POST.get('reading_date'))
        except ValueError:
            messages.error(request, 'La data o l\'ora non sono valide')
